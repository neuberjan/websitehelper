...
cmd_set_colors() {
    ...
    local color_data='[
        ...
        {"name": "Analyse & Reporting",  "color": "#7c3aed"},
        {"name": "API",                  "color": "#4f6ef7"},
        {"name": "AppSource",            "color": "#4f6ef7"},
        {"name": "Authentifizierung",    "color": "#dc2626"},
        {"name": "Azure",               "color": "#0284c7"},
        {"name": "Buchrezension",        "color": "#0d9488"},
        {"name": "Cloud",               "color": "#d97706"},
        {"name": "Community",            "color": "#0d9488"},
        {"name": "DevOps",              "color": "#7c3aed"},
        {"name": "Dokumentation",        "color": "#0284c7"},
        {"name": "E-Mail-Verwaltung",    "color": "#d97706"},
        {"name": "Entwicklung",          "color": "#7c3aed"},
        ...
        {"name": "Sicherheit",           "color": "#dc2626"},
        {"name": "Strategie & Migration","color": "#d97706"},
        {"name": "Telemetrie",           "color": "#db2777"},
        {"name": "Tools & Extensions",   "color": "#7c3aed"},
